...
class Settings(BaseSettings):
    ...
    ALGORITHM: str = "HS256"
    # 30 dias. Esta é uma aplicação de uso local/interno, onde relogar a cada 8h
    # era o principal atrito. Ajuste via ACCESS_TOKEN_EXPIRE_MINUTES no .env.
    # Nota: o JWT é stateless e não há blacklist — o logout não revoga o token,
    # então uma sessão longa permanece válida até expirar.
