...
export const API_ENDPOINTS = {
  ...
  AUTH_INVITE: `${API_PREFIX}/auth/invite`,
  AUTH_ACCEPT_INVITE: (token: string) => `${API_PREFIX}/auth/accept-invite/${token}`,
  ...
  // Organizations
  ORGANIZATIONS_ME: `${API_PREFIX}/organizations/me`,
  ORGANIZATIONS_ME_MODULES: `${API_PREFIX}/organizations/me/modules`,
  ORGANIZATIONS_DOMAIN: (domain: string) => `${API_PREFIX}/organizations/domain/${domain}`,
